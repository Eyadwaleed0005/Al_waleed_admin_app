import 'package:alwaleed_admin/core/helper/app_image_compression_helper.dart';
...
class ExamQuestionImagePicker extends StatefulWidget {
  const ExamQuestionImagePicker({
    super.key,
  ...
  @override
  State<ExamQuestionImagePicker> createState() {
    return _ExamQuestionImagePickerState();
  }
}

class _ExamQuestionImagePickerState extends State<ExamQuestionImagePicker> {
  ...
  Future<void> _pickImage() async {
    ...
    try {
      ...
      final String? validationMessage = AppImageValidator.validatePickedImage(
      ...
      final String? compressedValidationMessage =
      ...
      final String? originalPath = selectedFile.path?.trim();
  ...
  String _formatFileSize(int sizeInBytes) {
    final double sizeInKilobytes = sizeInBytes / 1024;

    final double sizeInMegabytes = sizeInKilobytes / 1024;
  ...
  Widget build(BuildContext context) {
    final ExamQuestionImageFile? selectedImage = widget.selectedImage;

    final String? normalizedCurrentImageUrl = widget.currentImageUrl?.trim();
